// const EditRecipePage = () => <div>Edit Recipe</div>;
...
const EditRecipePage = () => {
    ...
    const fetchRecipe = async () => {
      try {
        ...
        if (data.author._id !== user?._id) {
          toast.error('Not authorised to edit this recipe');
          navigate('/my-recipes');
          return;
        }
  ...
  // same handlers as AddRecipePage
  const addIngredient = () =>
    ...
    <Layout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          {/* basic info — same structure as AddRecipePage */}
          <div className="card p-6 space-y-5">
            ...
            <div className="grid grid-cols-3 gap-4">
              <Input label="Prep Time (min)" name="prepTime"
                type="number"
                register={register('prepTime', { required: 'Required' })}
                error={errors.prepTime?.message} />
              <Input label="Cook Time (min)" name="cookTime"
                type="number"
                register={register('cookTime', { required: 'Required' })}
                error={errors.cookTime?.message} />
              <Input label="Servings" name="servings"
                type="number"
                register={register('servings', { required: 'Required' })}
                error={errors.servings?.message} />
            </div>
          </div>

          {/* image — same as AddRecipePage */}
          <div className="card p-6">
            ...
            {imagePreview ? (
              <div className="relative">
                ...
                <button type="button"
                  ...
                  className="absolute top-2 right-2 bg-red-500
                             text-white w-7 h-7 rounded-full flex
              ...
              <label className="border-2 border-dashed border-gray-200
                                ...
                                transition-colors">
                <svg className="w-10 h-10 text-gray-300 mb-3" fill="none"
          ...
          {/* ingredients — same as AddRecipePage */}
          <div className="card p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">
              Ingredients
            </h2>
          ...
          {/* instructions — same as AddRecipePage */}
          <div className="card p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">
              Instructions
            </h2>
              ...
              {instructions.map((inst, index) => (
                <div key={index} className="flex gap-3">
                  ...
                  <div className="flex-1 flex gap-2">
                    <textarea placeholder={`Step ${inst.step}...`}
                      value={inst.text}
                      onChange={(e) =>
